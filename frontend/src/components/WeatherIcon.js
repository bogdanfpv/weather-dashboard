...
const WeatherIcon = ({
  ...
  const iconMap = {
    clear: (
      <Sun className={`${size} text-yellow-500 ${baseClasses} ${className}`} />
    ),
    sunny: (
      <Sun className={`${size} text-yellow-500 ${baseClasses} ${className}`} />
    ),
    ...
    cloudy: (
      <Cloud className={`${size} text-gray-500 ${baseClasses} ${className}`} />
    ),
    "partly-cloudy": (
      <Cloudy className={`${size} text-gray-400 ${baseClasses} ${className}`} />
    ),
    overcast: (
      <Cloud className={`${size} text-gray-600 ${baseClasses} ${className}`} />
    ),

    rain: (
      <CloudRain
        className={`${size} text-blue-500 ${baseClasses} ${className}`}
      />
    ),
    "light-rain": (
      <CloudDrizzle
        className={`${size} text-blue-400 ${baseClasses} ${className}`}
      />
    ),
    "heavy-rain": (
      <CloudRain
        className={`${size} text-blue-600 ${baseClasses} ${className}`}
      />
    ),
    drizzle: (
      <CloudDrizzle
        className={`${size} text-blue-300 ${baseClasses} ${className}`}
      />
    ),

    snow: (
      <CloudSnow
        className={`${size} text-blue-200 ${baseClasses} ${className}`}
      />
    ),
    "light-snow": (
      <CloudSnow
        className={`${size} text-blue-100 ${baseClasses} ${className}`}
      />
    ),
    "heavy-snow": (
      <CloudSnow className={`${size} text-white ${baseClasses} ${className}`} />
    ),

    thunderstorm: (
      <CloudLightning
        className={`${size} text-purple-500 ${baseClasses} ${className}`}
      />
    ),
    storm: (
      <CloudLightning
        className={`${size} text-purple-600 ${baseClasses} ${className}`}
      />
    ),

    fog: (
      <CloudFog
        className={`${size} text-gray-400 ${baseClasses} ${className}`}
      />
    ),
    mist: (
      <CloudFog
        className={`${size} text-gray-300 ${baseClasses} ${className}`}
      />
    ),
  };
...
// Weather condition mapper from OpenWeather API codes
