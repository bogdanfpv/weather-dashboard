...
def update_redis(weather_data, location_key):
    ...
    try:
        ...
        if weather_response.status_code == 200:
            ...
            print(f"Failed to update Redis for {location_key} - Weather: {weather_response.text}")
            return False
...
def lambda_handler(event, context):
    ...
    try:
        ...
        for location in cities_to_update:
            ...
            try:
                ...
                if redis_success:
                    ...
                    print(f"Partial failure for {city}, {country} - Redis: {redis_success}")
        ...
        if 'RequestType' in event:
            ...
            response_body = {
                'Status': 'SUCCESS',
                'Reason': 'Weather update completed',
            ...
            # Return early for CloudFormation - no need for HTTP response format
            return "SUCCESS"
